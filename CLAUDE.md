...
- **Next session candidate**: walk through `docs/CONTENT_REVIEW.md` per-page review on the 12 newly-authored compendiums (6 dimensions each: accuracy / completeness / consistency / sensitive data / vault artefacts / readability). Start with the thinner ones (73a-hensman, 14-15-gorge, 41-suburb-basecamp) to surface gaps that need owner input.
