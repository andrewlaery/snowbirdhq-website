  ...
  return (
    <div className='max-w-3xl mx-auto px-6 py-24'>
      ...
      <p className='font-sans text-muted leading-relaxed mb-6'>
        ...
        services provided by Snowbird HQ Property Management (&ldquo;Snowbird
        HQ,&rdquo; &ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;),
        a company registered in New Zealand (NZBN: 9429052471889). By engaging
      ...
      <p className='font-sans text-muted leading-relaxed mb-6'>
        ...
        short-term rental properties in Queenstown, New Zealand, including but
        not limited to:
      </p>
      <ul className='list-disc pl-6 font-sans text-muted leading-relaxed mb-6'>
      ...
      <ul className='list-disc pl-6 font-sans text-muted leading-relaxed mb-6'>
        ...
        <li>
          Ensure your property complies with all local regulations and safety
          standards
        </li>
        <li>
          Authorize us to act on your behalf for property management activities
        </li>
        <li>
          Pay all fees and charges as outlined in your management agreement
        </li>
        <li>
          Maintain the property in good condition suitable for guest occupancy
        </li>
      </ul>
      ...
      <p className='font-sans text-muted leading-relaxed mb-6'>
        We manage bookings according to agreed-upon policies, which may include:
      </p>
      <ul className='list-disc pl-6 font-sans text-muted leading-relaxed mb-6'>
        <li>
          Platform-specific cancellation policies (Airbnb, Booking.com, etc.)
        </li>
      ...
      <p className='font-sans text-muted leading-relaxed mb-6'>
        ...
        by law, Snowbird HQ&apos;s liability is limited to the management fees
        received for the affected period. We are not liable for:
      </p>
      <ul className='list-disc pl-6 font-sans text-muted leading-relaxed mb-6'>
      ...
      <p className='font-sans text-muted leading-relaxed mb-6'>
        ...
        photographs, and marketing materials, remains our intellectual property.
        You are granted a license to use such materials solely for promoting your
        property while under our management.
      </p>
      ...
      <h2 className='font-serif text-2xl mt-12 mb-4'>10. Termination</h2>
      <p className='font-sans text-muted leading-relaxed mb-6'>
        Either party may terminate the management relationship as specified in
        the Management Agreement. Upon termination:
      </p>
      <ul className='list-disc pl-6 font-sans text-muted leading-relaxed mb-6'>
        <li>
          We will honour existing confirmed bookings unless otherwise agreed
        </li>
      ...
      <h2 className='font-serif text-2xl mt-12 mb-4'>12. Governing Law</h2>
      <p className='font-sans text-muted leading-relaxed mb-6'>
        These Terms are governed by the laws of New Zealand. Any legal
        proceedings shall be brought exclusively in the courts of New Zealand.
      </p>
      ...
      <p className='font-sans text-muted leading-relaxed mb-6'>
        We may use WhatsApp Business for communications. By providing your phone
        number, you consent to receive service-related messages via WhatsApp. You
        may opt-out at any time by notifying us.
      </p>

      <h2 className='font-serif text-2xl mt-12 mb-4'>15. Amendments</h2>
      <p className='font-sans text-muted leading-relaxed mb-6'>
        We reserve the right to modify these Terms with 30 days notice to
        property owners. Continued use of our services after the effective date
      ...
      <p className='font-sans text-muted leading-relaxed mb-6'>
        These Terms, together with your Management Agreement and Privacy Policy,
        constitute the entire agreement between you and Snowbird HQ regarding
      ...
      <div className='border border-neutral-200 p-6 rounded mb-6'>
        ...
        <p className='font-sans text-muted'>Email: hello@snowbirdhq.com</p>
        <p className='font-sans text-muted'>Phone: +6421950670</p>
        <p className='font-sans text-muted'>
          Address: 85 Beach Street, Queenstown 9300, New Zealand
        </p>
        <p className='font-sans text-muted'>NZBN: 9429052471889</p>
        <p className='font-sans text-muted'>GST: 144-466-837</p>
      </div>

      <p className='font-sans text-muted leading-relaxed italic mt-8'>
