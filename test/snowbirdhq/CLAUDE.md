...
**Target Market**: High-net-worth property owners in Queenstown, NZ
**Property Focus**: Luxury rentals >$650/night ADR  
**Brand Style**: Minimalist luxury (inspired by Bower design)
**Color Palette**: Soft blue-gray (#B5D3D7) with black text on white
**Business Model**: B2B property management services
