...
- Update owner-log at `~/code/__Production/__server-bcampx/guest-ops/knowledge/owner-log/6-25-belfast.md` with the $300 lost-FOB replacement charge (operational record, not in guest guide) and check off Pete commitments #5 (2 FOBs documented) and #6 (sauna dial photo embedded) as shipped. (noticed 2026-04-21)
