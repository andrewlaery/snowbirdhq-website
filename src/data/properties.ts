...
export const properties: Property[] = [
  ...
  },
  {
    ...
    heroImage: '/properties/41-suburb-bonsai/hero.jpg',
    gallery: [
      { src: '/properties/41-suburb-bonsai/living.jpg', alt: 'Living room with lake views', layout: 'full' },
      { src: '/properties/41-suburb-bonsai/kitchen.jpg', alt: 'Modern kitchen', layout: 'split' },
      { src: '/properties/41-suburb-bonsai/bedroom.jpg', alt: 'Bedroom with mountain views', layout: 'split' },
      { src: '/properties/41-suburb-bonsai/sunroom.jpg', alt: 'Glass conservatory', layout: 'full' },
      { src: '/properties/41-suburb-bonsai/outdoor.jpg', alt: 'Outdoor dining terrace', layout: 'full' },
      { src: '/properties/41-suburb-bonsai/view.jpg', alt: 'Lake and mountain panorama', layout: 'full' },
    ],
    featured: true,
    hostawayId: 428528,
  },
