        ...
        <main className='max-w-4xl mx-auto px-4 py-6'>
          <div className='bg-white/90 backdrop-blur-md rounded-xl p-5 shadow-2xl'>
            ...
            <div className='prose text-gray-700 space-y-2'>
              ...
              <p>
                Taylor, we&apos;re so pleased to welcome you and your group of 5 to 25 Dublin Street! We know you&apos;ve been looking forward to your Queenstown visit, and we&apos;re delighted you&apos;ll be spending 4 nights with us. We&apos;ve got you all set for your midday check-in tomorrow as arranged. Your family is going to love the peaceful neighbourhood setting combined with easy access to all the incredible adventures and attractions that make Queenstown so special.
              </p>
